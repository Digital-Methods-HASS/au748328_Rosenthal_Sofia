---
title: "Kings"
author: "Sofia Rosenthal og Rikke Christiansen"
date: "2025-07-03"
...
library(tidyverse)
kings1 <- read.csv("data/Kings.csv", na = "na")
...
kingswithduration %>%
  ggplot(aes(x = Reign_start, y = Reign_length)) +
  geom_point() +
  geom_smooth() +
  theme_bw()
